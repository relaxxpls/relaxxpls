...
\resumeSubHeadingListStart
  ...
  {\href{https://github.com/relaxxpls/ResoBin}{\textbf{ResoBin}} $|$ \emph{ReactJS, Redux, Python, Django, PostgreSQL}}{(Mar. 2021 - Present)}
  ...
  \resumeItemListStart
    \resumeItem{Studied and compared various recurrent neural network architectures for time series predictions} 
    \resumeItem{Utilised LSTMs and CNNs in Tensorflow and ARIMA in statsmodels}
  \resumeItemListEnd
  ...
  \resumeItemListStart
    ...
    \resumeItem{Facilitated evaporative cooling by utilising a thin layer of water which reduced the cooling load by 5\%}
  \resumeItemListEnd

\resumeProjectHeading
{\textbf{CPPMatrixLib} $|$ \emph{C\Plus\Plus, CMake, GTest, TravisCI}}
{(Jan. 2021 -- Mar. 2021)}
{Summer of Code, IIT Bombay}
{}
\resumeItemListStart
\resumeItem{Designed and implemented a lightweight, template matrix computations library for C\Plus\Plus}
\resumeItem{Implemented algorithms include LU \& QR Decomposition, Fast Fourier Transform}
\resumeItem{Setup build and testing using CMake and GTest and CI/CD with Github Actions and TravisCI}
\resumeItemListEnd

\resumeProjectHeadingAlt
{\textbf{TeXURL} $|$ \emph{Python, Requests, \LaTeX, PyPI}}{(Mar. 2021 - Ongoing)}
\resumeItemListStart
\resumeItem{Built a Python package to assist \LaTeX compilers in processing links}
\resumeItem{Built a Python package to assist \LaTeX compilers in processing links}
\resumeItemListEnd

\resumeProjectHeading
{\textbf{Self  Suitcase} $|$ \emph{Python, OpenCV, ROS, Gazebo, RViz, RQT}}{(Mar. 2020 - Jul. 2020)}{Institute Technical Summer Project, IIT Bombay}{}
\resumeItemListStart
...
\resumeItemAltListStart
	\resumeItemAlt
    {\textbf{4\hspace{1pt}$\star$} at CodeChef (relaxxpls) and \textbf{1048\textsuperscript{th}} amongst \textbf{9000\Plus} participants in Googe Kickstart Sept. `20}
    {(2020)}
	\resumeItemAlt
...
% \resumeSubHeadingListStart
%   \resumeSubSubheading
%     {\textbf{\textsc{Computer Sci. : }} Machine Learning, Data Analysis, Numerical Analysis, Data Structures \& Algorithms}{} \vspace{-0.35cm}
%   \resumeSubSubheading
%     {\hspace{3.05cm}DSA Specialization (UC San Diego, Coursera), Machine Learning\textsuperscript{\textdagger} (CS50 Harvard, edX)}{}\vspace{-0.35cm}
%   \resumeSubSubheading
%     {\hspace{3.05cm}Data Structures \& Algoritms (Summer Of Science '20)}{[\ \textdagger\ : To be completed by Apr '21]}\vspace{-0.35cm}

%   \resumeSubSubheading
%     {\textbf{\textsc{Mathematics \hspace{3.5mm}: }}Numerical Analysis, Linear Algebra, Differential Equations, Discrete Structures\textsuperscript{\textdagger}}{}\vspace{-0.35cm}

%   \resumeSubSubheading
%     {\textbf{\textsc{Chemical Eng. : }}Process Fluid Mechanics\textsuperscript{\textdagger}, Heat Transfer\textsuperscript{\textdagger}, Thermodynamics, Computational Methods}{}\vspace{-0.3cm}
% \resumeSubHeadingListEnd
% \resumeItemAltListEnd
