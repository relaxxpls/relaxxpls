...
\newcommand{\contact}{(+91) 820-807-8914}
...
{\href{https://github.com/relaxxpls/ResoBin}{\textbf{ResoBin}} $|$ \emph{ReactJS, Redux, Python, Django, PostgreSQL}}
{(Mar. 2021 - Ongoing)}
{Summer of Code, IIT Bombay}
{}
\resumeItemListStart
\resumeItem{Ideated, designed and built a course material sharing website with the React-Redux framework} 
\resumeItemListEnd
  
\resumeProjectHeading
{\textbf{ResoBin} $|$ \emph{ReactJS, Redux, Python, Django, PostgreSQL}}
{(Mar. 2021 - Ongoing)}
{Summer of Code, IIT Bombay}
{}
\resumeItemListStart
...
\resumeProjectHeading
{\textbf{Optimize Heating Indoors} $|$ \emph{Python, SymPy, Pandas}}{(Feb. 2021 -- Apr. 2021)}{Heat Transfer Course Project, IIT Bombay}{}
\resumeItemListStart
\resumeItem{Analysed various heat sources} 
\resumeItemListEnd

\resumeProjectHeading
{\textbf{CPPMatrixLib} $|$ \emph{C++, CMake, GTest, TravisCI}}
{(Jan. 2021 -- Mar. 2021)}
{Summer of Code, IIT Bombay}
{}
\resumeItemListStart
\resumeItem{Designed and implemented a lightweight, template matrix computations library for C++}
...
\begin{adjustwidth}{10.8pt}{}
	\resumeItemAlt
    {\textbf{4\hspace{1pt}$\star$} at CodeChef (relaxxpls) and \textbf{1048\textsuperscript{th}} amongst \textbf{9000+} participants in Googe Kickstart Sept. `20}
    {(2020)}
	\resumeItemAlt
...
\techSkillListStart
  ...
  \techSkill{Libraries}{TensorFlow, Keras, Torch, Pandas, OpenCV, Pillow, NumPy, SKLearn, SymPy, SciPy, Tesseract}
...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{Co-organised and coordinated \textbf{10+} departmental events, managing \textbf{1000+} unique students in total}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Spearheaded a team of \textbf{20+} freshmen to manage the media and publicity for ShowStopper '21 -- the institute's largest fashion show attaining a staggering attendance of \textbf{300+} even during an online semester}
...
\resumeSubHeadingListStart
  \resumeSubSubheading
    {\textbf{\textsc{Computer Sci. : }} Machine Learning, Data Analysis}{} \vspace{-0.35cm}
  \resumeSubSubheading
